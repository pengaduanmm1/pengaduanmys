<table class="responsive-table" border="6" style="width: 100%;">
	<tr>
		<td><h2 class="blck-text">Daftar Laporan</h2></td>
	</tr>
		<td>
			...
			<table border="11" class="responsive-table striped highlight">
				...
				<?php 
					...
					<tr>
						<td><font color="black"><?php echo $no++; ?></font></td>
						<td><font color="black"><?php echo $r['nik']; ?></font></td>
						<td><font color="black"><?php echo $r['nama']; ?></font></td>
						<td><font color="black"><?php echo $r['tgl_pengaduan']; ?></font></td>
						<td><font color="black"><?php echo $r['status']; ?></font></td>
						<td>
							<a class="btn aqua modal-trigger" href="#tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Detail</a> 
